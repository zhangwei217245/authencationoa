 ...
 */
@Transactional
public class DocumentpathService extends JpaDaoSupport implements IEntityService {
    ...
    public void destroy(Integer id) {
        getJpaTemplate().remove(getJpaTemplate().find(Documentpath.class, id));

    }

    public void destroy(String sid) {
        getJpaTemplate().remove(getJpaTemplate().find(Documentpath.class, Integer.parseInt(sid)));
            ...
            public Object doInJpa(EntityManager em) throws PersistenceException {
                ...
                try {
                    ...
                    if (jpql == null || jpql.equals("")) {
                        ...
                        ql = "select object(o) from Documentpath as o";
    ...
    public IEntity findOneEntityById(Integer id) {
        return getJpaTemplate().find(Documentpath.class, id);
    }

    @Transactional(propagation = Propagation.NOT_SUPPORTED, readOnly = true)
    public IEntity findOneEntityById(String id) {
        return getJpaTemplate().find(Documentpath.class, Integer.parseInt(id));
    }
            ...
            public Object doInJpa(EntityManager em) throws PersistenceException {
                try {
                    ...
                    if (jpql == null || jpql.equals("")) {
                        ...
                        ql = "select count(o) from Documentpath as o";
