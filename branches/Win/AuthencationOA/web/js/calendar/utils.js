...
Zapatec.Utils.Array.insertBefore = function (arr, el, key, nextKey) {
 ...
 function chanageTime(id){
	var orc = document.getElementById(id);
	var temp = document.getElementById(id+"_ch");
	temp.style.backgroundColor = "#e2e2e2";
	orc.style.display = "none";
	temp.style.display = "";
	temp.value = orc.value;
	temp.focus();
  }
  function backToInput(id){
	var orc = document.getElementById(id);
	var temp = document.getElementById(id+"_ch");
	temp.style.backgroundColor = "red";
	orc.style.display = "";
	temp.style.display = "none";
	orc.value = temp.value;
  }
