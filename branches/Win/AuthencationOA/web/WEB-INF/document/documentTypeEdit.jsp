...
<!DOCTYPE HTML PUBLIC "-//W3C//DTD HTML 4.01 Transitional//EN"
   ...
   <html:html locale="true">
        <head>
            ...
            <title><bean:message key="title.document.type.edit"/></title>
            <script>
     ...
     <body style="background-color: white">
        ...
        <h4><bean:message key="title.document.type.edit"/></h4>
        ...
        <html:form action="/Document/documentTypeEdit.do" onsubmit="selectall();" method="post">
            <html:hidden property="numtypeid"/>
            <center>
