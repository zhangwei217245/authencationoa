...
"\n\n" +
"Як вибрати дату:\n" +
"- За допомогою кнопок \xab, \xbb можна вибрати р_к\n" +
"- За допомогою кнопок " + String.fromCharCode(0x2039) + ", " + String.fromCharCode(0x203a) + " можна вибрати м_сяць\n" +
"- Утримуйте натиснутими ці кнопки, щоб з'явилося меню швидкого вибору.",
   "ABOUT_TIME" : "\n\n" +
"Як вибрати час:\n" +
"- При клацанн_ на годинах чи хвилинах вони зб_льшуються\n" +
"- при клацанн_ з натиснутою клав_шою Shift вони зменшуються\n" +
