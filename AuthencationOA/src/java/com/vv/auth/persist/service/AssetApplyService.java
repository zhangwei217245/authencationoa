...
import com.vv.auth.persist.entity.AssetApply;
 ...
 */
@Transactional
public class AssetApplyService extends JpaDaoSupport implements IEntityService {
    ...
    public IEntity findOneEntityById(Integer id) {
        return getJpaTemplate().find(AssetApply.class, id);
    }
    ...
    public IEntity findOneEntityById(String sid) {
        return getJpaTemplate().find(AssetApply.class, sid);
    }
            ...
            public Object doInJpa(EntityManager em) throws PersistenceException {
                try {
                    ...
                    if (jpql == null || jpql.equals("")) {
                        ql = "select object(o) from AssetApply as o";
                    }
        ...
        return ((Long) getJpaTemplate().execute(new JpaCallback() {
            ...
            public Object doInJpa(EntityManager em) throws PersistenceException {
                try {
                    String ql = jpql;
                    if (jpql == null || jpql.equals("")) {
                        ql = "select count(o) from AssetApply as o";
                    }
